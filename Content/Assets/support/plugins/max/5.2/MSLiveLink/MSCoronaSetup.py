        ...
        if self.coronaVersion > 6:
            ...
            (
                ...
                (
                    ...
                    MAT_NODE_NAME.edgeColorTexmap = MAT_NODE_NAME.baseTexmap
                )
            ...
            (
                ...
                (
                    ...
                    MAT_NODE_NAME.baseBumpTexmap.NormalMap = CoronaTriplanar ()
                    MAT_NODE_NAME.baseBumpTexmap.NormalMap.scale = 0.55
                    MAT_NODE_NAME.baseBumpTexmap.NormalMap.name = ("Nrm")

                    MAT_NODE_NAME.baseBumpTexmap.NormalMap.texmapX = CoronaBitmap()
                    MAT_NODE_NAME.baseBumpTexmap.NormalMap.texmapX.name = ("Normal")
                    MAT_NODE_NAME.baseBumpTexmap.NormalMap.texmapX.filename = ("TEX_NORMAL")
                    MAT_NODE_NAME.baseBumpTexmap.NormalMap.texmapX.gamma = 1.0
                    MAT_NODE_NAME.baseBumpTexmap.NormalMap.texmapX.interpolation = 1
                    MAT_NODE_NAME.baseBumpTexmap.NormalMap.texmapX.filteringBlur = 0.01
                )
            )
